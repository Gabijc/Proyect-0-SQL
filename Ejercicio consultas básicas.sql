...
select 
	...
	"Name" 
from "Playlist" p
where "PlaylistId" = 5 or "PlaylistId" = 8 or "PlaylistId" = 1 or "PlaylistId" = 9;
...
from "Track"
where "UnitPrice" > 1 or "Milliseconds" < 300.000;
...
-- NO EXISTE NINGÚN EMPLEADO QUE SEA DE SEATTLE O CUYO ESTADO SEA WA.
...
from "Track"
where "Milliseconds" > 250.000 and "MediaTypeId" between 1 and 2;
